...
>
  <li>
    ...
    <div class="timeline-start mb-10 md:text-end">
      <time class="font-mono italic">(August 20, 2024) v0.1</time>
      <div class="text-lg font-black">Fixed mobile bug</div>
      Fixed mobile bug where users couldn't add their account on their phone and
      also added changelogs page to keep track of updates
    </div>
    <hr />
  </li>
  <!--
  ...
  <li>
    ...
    <div class="timeline-start mb-10 md:text-end">
      ...
      mobile devices designed and marketed by Apple Inc. The first version was released
      on October 23, 2001, about 8+1⁄2 months after the Macintosh version of iTunes
      was released. Apple sold an estimated 450 million iPod products as of 2022.
      Apple discontinued the iPod product line on May 10, 2022. At over 20 years,
  ...
  <li>
    ...
    <div class="timeline-end mb-10">
      ...
      iOS mobile operating system. The first-generation iPhone was announced by then-Apple
      CEO Steve Jobs on January 9, 2007. Since then, Apple has annually released
      new iPhone models and iOS updates. As of November 1, 2018, more than 2.2 billion
